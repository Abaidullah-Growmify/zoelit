...
export const setProductPriority = (id, isPriority, token) =>
  request(`/api/admin/products/${encodeURIComponent(id)}/priority`, {
    method: "PATCH",
    body: { isPriority },
    token,
  });
...
export const setCategoryPriority = (category, isPriority, token) =>
  request(`/api/admin/products/categories/${encodeURIComponent(category)}/priority`, {
    method: "PATCH",
    body: { isPriority },
    token,
  });
...
export const deleteAdminCategory = (category, token) =>
  request(`/api/admin/products/categories/${encodeURIComponent(category)}`, {
    method: "DELETE",
    token,
  });
