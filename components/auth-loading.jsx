...
export function AuthLoading({ label = "Loading secure access..." }) {
  return (
    <div className="grid min-h-[420px] w-full max-w-md place-items-center rounded-lg border border-white/30 bg-white/10 p-8 text-center shadow-2xl shadow-blue-950/10 backdrop-blur-md dark:border-white/10 dark:bg-white/5">
      <div>
