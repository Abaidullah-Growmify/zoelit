      ...
      <div className="flex gap-5">
        ...
        <div className="flex min-w-0 flex-1 flex-col justify-between gap-4">
          <div className="min-w-0 pr-10">
            ...
            <p className="mt-2 text-base font-semibold tabular-nums text-slate-500 dark:text-slate-400">{money(product.price)}</p>
          </div>
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="inline-flex shrink-0 items-center gap-3 rounded-lg bg-slate-100 px-3 py-1.5 dark:bg-slate-800">
              ...
              <span className="min-w-5 text-center text-base font-semibold tabular-nums text-slate-950 dark:text-white">{item.quantity}</span>
            ...
            <p className="shrink-0 text-right text-lg font-semibold tabular-nums text-slate-950 dark:text-white">{money(product.price * item.quantity)}</p>
          </div>
        </div>
