  ...
  return (
    <section className="container-page py-12">
      <div className="grid gap-10 lg:grid-cols-2">
        <Card className="p-3"><Image src={product.image} alt={product.name} width={1000} height={1000} priority className="aspect-square w-full rounded-3xl object-cover" /></Card>
